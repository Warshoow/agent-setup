...
- **Conventional Commits**, sujet en **anglais** (`feat:`, `fix:`, `chore:`, `refactor(scope): …`), en calquant le style des commits récents du repo.
...
# graphify
- **graphify** (`~/.claude-pro/skills/graphify/SKILL.md`) - any input to knowledge graph. Trigger: `/graphify`
